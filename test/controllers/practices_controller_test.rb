...
class PracticesControllerTest < ActionController::TestCase
  ...
  test "should create practice" do
    assert_difference('Practice.count') do
      post :create, practice: { lesson_id: @practice.lesson_id, question: @practice.question, right_answer: @practice.right_answer }
    end
  ...
  test "should update practice" do
    patch :update, id: @practice, practice: { lesson_id: @practice.lesson_id, question: @practice.question, right_answer: @practice.right_answer }
    assert_redirected_to practice_path(assigns(:practice))
  end
